...
\lstinputlisting[style=ANTLR,linerange={125-127}]{../g-files/SELMA.g}
...
\subsubsection{Syntax}
\lstinputlisting[style=ANTLR,linerange={173-183}]{../g-files/SELMA.g}
\subsubsection{Context}
\begin{itemize}
...
\subsubsection{Syntax}
\lstinputlisting[style=ANTLR,linerange={209-225}]{../g-files/SELMA.g}
\subsubsection{Context}
\begin{itemize}
...
\subsubsection{Syntax}
\lstinputlisting[style=ANTLR,linerange={227-229}]{../g-files/SELMA.g}
\subsubsection{Context}
\begin{itemize}
...
\subsubsection{Syntax}
\lstinputlisting[style=ANTLR,linerange={189-191}]{../g-files/SELMA.g}
\subsubsection{Context}
\begin{itemize}
\item -
\end{itemize}
